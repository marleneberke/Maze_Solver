...
#################################################################################
file_to_read = "path.txt" #so arg should be path1 or something like that
...
print(file, "shuffle, ", "15_by_15_maze_6, ", locations[t_pause-1], ", ", time_spent_here[t_pause], ", ", distracted, ", ", thinking, ", ", sd_distracted, "\n")
